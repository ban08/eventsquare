    ...
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <p class="mt-3 text-sm text-slate-600">
                These terms describe how you can use EventSquare.
            </p>

            <div class="mt-8 space-y-6 text-sm text-slate-600">
                <div>
                    <h2 class="text-base font-semibold text-slate-900">Acceptable use</h2>
                    <p class="mt-2">
                        Be respectful, follow event rules, and do not misuse the platform.
                    </p>
                </div>
                <div>
                    <h2 class="text-base font-semibold text-slate-900">Organizer responsibilities</h2>
                    <p class="mt-2">
                        Organizers are responsible for event accuracy, safety, and communication with attendees.
                    </p>
                </div>
                <div>
                    <h2 class="text-base font-semibold text-slate-900">Changes</h2>
                    <p class="mt-2">
                        We may update these terms periodically. Continued use means you accept updates.
                    </p>
                </div>
            </div>
        </div>
