        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                ...
                <div class="relative pl-16">
                    ...
                    <dd class="mt-2 text-base leading-7 text-gray-600">Find exactly what you're looking for with our powerful full-text search and filtering capabilities.</dd>
                </div>
            ...
            <div class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="border-l-2 border-gray-800 pl-6 pt-2 text-gray-300">
                        ...
                        <p><a href="#" class="hover:text-white">Terms of Service</a></p>
                    </div>
                </div>
            </div>
        </div>
